      ...
      async markdownItSetup(md) {
        ...
        md.use(MarkdownItMagicLink, {
          ...
          imageOverrides: [
            ...
            ['https://go.dev', 'https://go.dev/blog/go-brand/Go-Logo/PNG/Go-Logo_Aqua.png'],
            ['https://www.docker.com', 'https://www.docker.com/wp-content/uploads/2022/03/Moby-logo.png'],
            ['https://kubernetes.io', 'https://raw.githubusercontent.com/kubernetes/kubernetes/master/logo/logo.png'],
            ['https://www.counter-strike.net', 'https://www.counter-strike.net/img/csgo_logo.png'],
            ['https://www.nba.com', 'https://cdn.nba.com/logos/nba-logo.png'],
            ['https://www.premierleague.com', 'https://resources.premierleague.com/premierleague/badges/pl-logo.png'],
